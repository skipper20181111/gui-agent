...
- [2. GUI Agent 挂号场景 Demo（可快速迁移 Go/Java）](#2-gui-agent-挂号场景-demo可快速迁移-gojava)
  - [2.1 项目简介](#21-项目简介)
...
GUI Agent 作为自动化执行层，理论上可以与阿福协同：**阿福提供健康决策支持，GUI Agent 负责执行落地**。但当前 GUI Agent 技术仍处于早期探索阶段，存在以下局限：
...
## 2. GUI Agent 挂号场景 Demo（可快速迁移 Go/Java）
